...
export class ListNav {
    ...
    static buildListReference(
        ...
        // construct new session state instance (assuming this list is the new active list) and store in session
        const newState = new ListNavSessionState({ activeList: listRef });
    ...
    //
    static getProvider(listRef: ListReference) {
